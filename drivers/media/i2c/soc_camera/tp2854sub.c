				 ...
				 struct v4l2_mbus_config *cfg)
{
	...
	//pr_debug("tp2854_g_mbus_config addr %x\n",client->addr);
    ...
    struct v4l2_subdev_pad_config *cfg, struct v4l2_subdev_selection *sel)
{
	...
	pr_debug("tp2854sub_get_selection\n");
    ...
    struct v4l2_subdev_pad_config *cfg, struct v4l2_subdev_selection *sel)
{
	...
	pr_debug("tp2854sub_set_selection\n");
    ...
    struct v4l2_subdev_pad_config *cfg, struct v4l2_subdev_mbus_code_enum *code)
{
	...
	/* pr_debug("tp2854sub_enum_mbus_code\n"); */
